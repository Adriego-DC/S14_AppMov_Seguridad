...
class MainActivity : AppCompatActivity() {
    ...
    private val permissions = listOf(
        ...
        description = "Ver accesos, alertas y exportar logs",
        permission = null,
        activityClass = SecurityAuditActivity::class.java
    ),
        PermissionItem(
            name = "Autenticación Segura",
            description = "Escaneo biométrico o PIN",
            permission = null,
            activityClass = BiometricAuthActivity::class.java
        )
    )
